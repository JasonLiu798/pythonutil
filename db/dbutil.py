...
#-*- coding:utf-8 -*-
#
# Copyright 2016 jasonliu
# fork from git@github.com:fkook/python_mysql.git
#
...
class Connection(object):
    ...
    def __init__(self, host, database, user=None, password=None ):
        ...
        # use_unicode=True, conv=CONVERSIONS,
    ...
    def reconnect(self):
        ...
        self.close()
        self._db = mysql.connect(**self._db_args)
